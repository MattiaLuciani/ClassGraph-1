...
#sgafile = '/Users/mattialuciani/Desktop/università_magistrale/bioinformatics/AlgoBio/SimDataset/sga_all_Davide.asqg'
#sgafile = '/Users/mattialuciani/Desktop/Sim8_11.asqg'


#asqg
kraken2_file = '/Users/mattialuciani/ClassGraph/Testing-Files/binning.res'
#kraken2_file = '/Users/mattialuciani/Desktop/università_magistrale/bioinformatics/AlgoBio/SimDataset/strex_kraken2_250000.res'
#kraken2_file = '/Users/mattialuciani/Desktop/università_magistrale/bioinformatics/AlgoBio/SimDataset/strex_centrifuge_250000_mod.res'
#kraken2_file = '/Users/mattialuciani/Desktop/università_magistrale/bioinformatics/AlgoBio/SimDataset/strex_clark_species_250000_mod.res'
#kraken2_file = '/Users/mattialuciani/Desktop/kraken_out_mini.rescd'
...
for read in range(node_count):
    #count = count + 1
    line = []
    line.append(read)#prendo le read e le metto dentro a delle liste
    
    if int(reads_info[read]) != 0: #reads_info = krakenlabels[i][1]
        alreadyLabelled = []
